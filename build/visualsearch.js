...
this["JST"]["search_box"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class="VS-search '; if (readOnly) { ;__p += 'VS-readonly'; } ;__p += '">\n  <div class="VS-search-box-wrapper VS-search-box">\n    <div class="VS-icon VS-icon-search"></div>\n    <div class="VS-placeholder"></div>\n    <div class="VS-search-inner"></div>\n    <div class="VS-icon VS-icon-cancel VS-cancel-search-box" title="clear search"></div>\n  </div>\n</div>';}return __p};

this["JST"]["search_facet"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) { if (model.has('category')) { ;__p += '\n  <div class="category">' +__e( model.get('category') ) +':</div>\n'; } ;__p += '\n\n<div class="search_facet_input_container">\n  <input type="text" class="search_facet_input ui-menu VS-interface" value="" '; if (readOnly) { ;__p += 'disabled="disabled"'; } ;__p += ' />\n</div>\n\n<div class="search_facet_remove VS-icon VS-icon-cancel"></div>';}return __p};

this["JST"]["search_input"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<input type="text" class="ui-menu" '; if (readOnly) { ;__p += 'disabled="disabled"'; } ;__p += ' />';}return __p};